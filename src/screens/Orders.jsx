import { View, Text, SafeAreaView, FlatList, TouchableOpacity, Image, Dimensions, StyleSheet } from 'react-native'
        ...
        <SafeAreaView style={{ flex: 1, paddingTop: 50 }}>
            <View style={{ flex: 1 }}>
                ...
                <View style={{ width: '100%', paddingHorizontal: 20, alignItems: 'center' }}>
                    <View style={{ width: '100%', borderRadius: 7, borderCurve: 'continuous', backgroundColor: 'white', }}>
                        <View style={{ height: 180, backgroundColor: 'pink', borderTopLeftRadius: 7, borderTopRightRadius: 7 }} />
                        <View style={{ paddingVertical: 14, paddingHorizontal: 14 }}>
                            <Text style={{ fontSize: 18, fontWeight: '600' }}>$ 1200 / month</Text>
                            <Text style={{ maxWidth: 250, fontSize: 16, paddingTop: 10, fontWeight: '400', color: Gray.gray600 }}>Hero Honda Bike with 6 Gear in Best condition</Text>
                        </View>
                    </View>
                </View>
