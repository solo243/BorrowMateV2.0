...
const Home = ({ navigation }) => {
  ...
  const Fetching = async () => {
    const fetching = await fetch(
      "https://server7-wb1d.onrender.com/v12/popular/post"
    );
      ...
      <SafeAreaView style={style.mainContainer}>
        ...
        <View style={style.navigationBar}>
          ...
          <View style={style.bellBagRow}>
            <TouchableOpacity
              onPress={() => navigation.navigate("Notificaiton")}
              style={style.topIconCont}
            >
        ...
        <View style={style.searchBarCont}>
          ...
          >
            ...
            <Text style={style.searchText}>Search Anything...</Text>
          </TouchableOpacity>
        </View>
        {/* TODO: ADsection  */}
        ...
        {/* TODO: Category Row  */}
        {/* <Text className="text-xl bg-red-900">hello me </Text> */}
