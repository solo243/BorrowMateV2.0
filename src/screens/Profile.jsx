...
import { signOutFunction } from "../firebase/firebase.function";
import axios from "axios";
import { BASE_URL } from "../constants/SampleData";
import { getAuth } from "firebase/auth";

const Profile = ({ navigation }) => {
  const handlePreassSignOut = () => {
    console.log("Profile");
    signOutFunction();
  };
  ...
  const fetchingData = async () => {
    try {
      const url = `${BASE_URL}/profile/profilepost/${userUID}`;
              ...
              <SafeAreaView style={style.mainCont}>
                ...
                <View>
                  <View style={style.userProfileCont}>
                    <Image
                      source={{
                        uri: "https://i.pinimg.com/originals/f2/d0/ac/f2d0ac079588297a2bd818a4c061ec71.jpg"
                      }}
                      style={{
                        height: 100,
                        width: 100,
                  ...
                  <View style={{ gap: 1, paddingHorizontal: 10 }}>
                    ...
                    >
                      ...
                      Iste consectetur quas velit unde aliquam voluptates porro
                      molestiae nam quaerat possimus!
                    </Text>
                    <Text
                      style={{
                        fontSize: 20,
